...
def select_features_with_rf(X_train_res, y_train_res, X_test_scaled, X_train_scaled):
    ...
    Keeps only features above the median importance score.
    Returns:
        - X_train_sel: selected training features
        - X_test_sel: selected test features
        - X_test_sel_df: DataFrame version of selected test features
